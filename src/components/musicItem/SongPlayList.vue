<template>
    <div id="songPlayList">
        ...
        <div class="singleItem" v-for="(item, index) in props.playListDetail" :key="index"
            ...
            <div class="tool">
                <div class="nowToPlayIcon" v-if="
                    item?.id === playListStore.playList[playListStore.nowToPlayId]?.id
                ">
                ...
                <div class="order" v-else>
                    {{ countOrder(index + props.orederBaseCount) }}
                </div>
                <div class="favourite">
                    <div class="iconItem">
            ...
            <div class="content">
                <div class="contentItem" v-for="(settingItem, settingIndex) in props.titleSetting" :key="settingIndex"
                    ...
                    <span v-else-if="settingItem.props === 'singer'"
                        ...
                        <span class="singer" @click="goToSinger(item, singerIndex)">{{
                                singerItem
                        }}</span>
